...
class PublySettlementService extends BaseApiService
{
    ...
    public function storeAndTransferMultiple($changerId, $authors) {
        return $this->post("author_settlement_transfer/store-and-transfer-multiple", [
            'changer_id' => $changerId,
            'authors' => $authors
        ]);
    }
    ...
    public function cancelAuthorSettlementTransfer($changerId, $authorSettlementTransferId)
    {
        return $this->put("author_settlement_transfer/{$authorSettlementTransferId}", [
            'changer_id' => $changerId,
            'action' => 'cancel'
    ...
    public function getProjectSettlementAuthorResultsTotalPriceGroupByAuthor($filterArray = [])
    {
        return $this->get("project_settlement_author_result/total_price_group_by_author", $filterArray);
    }
}