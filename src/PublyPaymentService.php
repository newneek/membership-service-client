...
class PublyPaymentService extends BaseApiService
{
    ...
    const POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_COMPLETE_CAREERLY_PROFILE = 12;
    ...
    const POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_PROMOTION = 16;
    const POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_EVENT = 17;
    // const POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_POPUP_STORE_SIGNUP = 17;
    const POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_POPUP_STORE_LOGIN = 18; //다른 이벤트로 덮어버릴예정. 값도 수정할 예정.
    const POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_EXPIRING_CAMPAIGN = 19;
    const POINT_HISTORY_TRANSACTION_TYPE_MAX = 20;
    ...
    const STRING_TRANSACTION_TYPE = [
        ...
        PublyPaymentService::POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_EVENT => '이벤트 포인트',
        PublyPaymentService::POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_POPUP_STORE_LOGIN => '이벤트 포인트',
    ...
    public const POINT_HISTORY_ONLY_ADD_POINT_TRANSACTION_TYPES = [
        ...
        self::POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_COMPLETE_CAREERLY_PROFILE
    ];
    ...
    {
        return $this->post("/order_comment/", [
            'changer_id' => $changerId,
            'order_id' => $orderId,
            'comment' => $comment
        ]);
    ...
    {
        return $this->put(
            "/subscription/cancel_subscription_reserved",
            [
                'changer_id' => $changerId,
    ...
    {
        return $this->put(
            "/subscription/renew_subscriptions",
            [
                'changer_id' => $changerId,
                'renew_day' => implode(',', $days)
            ]
    ...
    public function requestRefundSubscriptionRenewalHistory(
        $changerId,
        $subscriptionId,
        ...
        return $this->put(
            "subscription_renewal_history/{$subscriptionRenewalHistoryId}",
            [
                'changer_id' => $changerId,
                'subscription_id' => $subscriptionId,
                'action' => 'request-refund',
    ...
    public function completeRefundSubscriptionRenewalHistory(
        $changerId,
        $subscriptionId,
        $subscriptionRenewalHistoryId,
        $force = false
    ...
    public function updatePlanToken($changerId, $planTokenId, $expireDate, $quantity, $planTitle, $labelTag, $labelColor, $displayPrice, $texts, $notes, $imagePc, $imageMobile, $setIds)
    {
        $inputs = [
            'changer_id' => $changerId,
            'expire_date' => $expireDate,
    ...
    {
        return $this->get("point_history/by_user_ids/sums", ['user_ids' => implode(',', $userIds)]);
    }
    ...
    public function notifyCustomContentRecommendation($daysBeforeExpired)
    {
        return $this->post("/subscription/notify_custom_content_recommendation", [
            'days_before_expired' => $daysBeforeExpired
        ]);
    }
