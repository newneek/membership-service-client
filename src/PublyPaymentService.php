...
class PublyPaymentService extends BaseApiService
{
    ...
    const POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_PRMOTION_REFERRAL_SIGNUP_REFERRER = 13;
    const POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_PRMOTION_REFERRAL_SIGNUP_REFEREE = 14;
