...
class PublyPaymentService extends BaseApiService
{
    ...
    const POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_REFEREE = 8;
    const POINT_HISTORY_TRANSACTION_TYPE_MAX = 9;
    ...
    const STRING_TRANSACTION_TYPE = [
        ...
        PublyPaymentService::POINT_HISTORY_TRANSACTION_TYPE_REWARDED_BY_REFEREE => "레퍼럴 포인트 지급"
    ];
