...
class PublyContentService extends BaseApiService
{
    ...
    const CURATION_TYPE_TEMPLATE = 14;
    ...
    public function getUserContentProgressesBySetIds($userId, $setIds, $filterArray = [])
    {
        $filterArray['set_ids'] = implode(',', $setIds);
        return $this->get("user_content_progress/user/{$userId}/by_set_ids", $filterArray);
    }
    ...
    public function updateGuide($changerId, $guideId, $title, $mastheadImageUrl, $coverImageUrl, $metaKeywords)
    {
